...
public class KinematicPhysicsSystem : ISystem
{
    ...
    {
        foreach (var immutablePhysics in _registry.GetComponents<BodyPhysicsComponent>().ToArray())
        {
            if (!immutablePhysics.Kinematic) continue;
